...
class SRDataset(Dataset):
    ...
    def __init__(self, data_folder, split, crop_size, scaling_factor, lr_img_type, hr_img_type, if_srcnn, test_data_name=None):
        """
        ...
        assert lr_img_type in {'[0, 255]', '[0, 1]', '[-1, 1]', 'imagenet-norm','y-channel'}
        assert hr_img_type in {'[0, 255]', '[0, 1]', '[-1, 1]', 'imagenet-norm','y-channel'}
